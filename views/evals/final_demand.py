...
from esmtools.evals.heat import get_heat_loss_factor, split_heat_hh_service_losses
from esmtools.evals.industry import (
    INDUSTRY_BUS_CARRIER,
    fetch_industry_demand_statistics,
)
from esmtools.fileio import prepare_industry_demand, prepare_nodal_energy
from esmtools.metric import Metric
from esmtools.plots.barchart import ESMBarChart
from esmtools.plots.facetbars import ESMGroupedBarChart
...
def eval_fed(
    ...
    Notes
    -----
    See esmtools.evals docstring for parameter description.
    """
...
def eval_fed_sectoral(
    ...
    metric.cfg.plotly.cutoff = 0.0  # None in original predecessor
    metric.cfg.plotly.category_orders = (
        Group.coal,
        Group.solar_thermal,
        Group.biomass,
...
def _fetch_fed_district_heat(networks: dict) -> pd.Series | pd.DataFrame:
    ...
    """
    # fixme: why does the predecessor use "p_set" instead of "p" for
    #  heat loads?
