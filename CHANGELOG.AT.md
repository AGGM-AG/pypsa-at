...
### Added
- On-demand `plot_model_map_at` rule drawing print-quality maps of power plants and Hotmaps industrial sites on the electricity and SciGRID_gas pipeline grids
