...
rule create_onshore_regions_nuts3:
    ...
    output:
        regions_nuts3=resources_shared("regions_onshore_nuts3_base_s_{clusters}.geojson"),
    log:
    ...
    input:
        **{
            **rules.determine_availability_matrix.input,
            "regions": resources_shared("regions_onshore_nuts3_base_s_{clusters}.geojson")
        }
    output:
    ...
    input:
         **{
            **rules.build_renewable_profiles.input,
            "availability_matrix":resources_shared("availability_matrix_nuts3_{clusters}_{technology}.nc"),
            "distance_regions": resources_shared("regions_onshore_nuts3_base_s_{clusters}.geojson"),
            "resource_regions": resources_shared("regions_onshore_nuts3_base_s_{clusters}.geojson")
        }
    output:
        **{
            **rules.build_renewable_profiles.output,
            "profile":resources_shared("profile_nuts3_{clusters}_{technology}.nc"),
            "class_regions":resources_shared("regions_by_class_nuts3_{clusters}_{technology}.geojson"),
        },
    wildcard_constraints:
        technology="onwind",
    log:
...
if config["clustering"]["administrative"]["AT"] == 2:
    ...
    use rule build_renewable_profiles as build_renewable_profiles_onwind_nuts2 with:
        output:
            **{
                **rules.build_renewable_profiles.output,
                "profile":resources_shared("profile_nuts2_{clusters}_{technology}.nc"),
                "class_regions":resources_shared("regions_by_class_nuts2_{clusters}_{technology}.geojson"),
            },
        wildcard_constraints:
            technology="onwind",
        log:
    ...
    rule build_renewable_profiles_onwind_klien:
        input:
            ...
            class_regions_nuts2=resources_shared("regions_by_class_nuts2_{clusters}_{technology}.geojson"),
