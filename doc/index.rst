...
PyPSA-Eur-Sec is designed to be imported into the open predecessor `PyPSA <https://www.pypsa.org>`_ for which `documentation <https://pypsa.org/doc>`_ is available as well.
