...
if __name__ == "__main__":
    ...
    if admin_levels.get("DE") == 3:
        ...
        suffix = ""
        override_nuts("DE1", f"DE1{suffix}", level="level3")
        # Bavaria
        override_nuts("DE2", f"DE2{suffix}", level="level3")
        # Midwest (HE, RP, SL, NW)
        override_nuts("DE7", f"DE3{suffix}", level="level3")
        override_nuts("DEB", f"DE3{suffix}", level="level3")
        override_nuts("DEC", f"DE3{suffix}", level="level3")
        override_nuts("DEA", f"DE3{suffix}", level="level3")
        # Mideast (BB, BE, MV, SN, ST, TH)
        override_nuts("DE3", f"DE4{suffix}", level="level3")
        override_nuts("DE4", f"DE4{suffix}", level="level3")
        override_nuts("DE8", f"DE4{suffix}", level="level3")
        override_nuts("DED", f"DE4{suffix}", level="level3")
        override_nuts("DEE", f"DE4{suffix}", level="level3")
        override_nuts("DEG", f"DE4{suffix}", level="level3")
        # North (SH, HH, HB, NI)
        override_nuts("DEF", f"DE5{suffix}", level="level3")
        override_nuts("DE6", f"DE5{suffix}", level="level3")
        override_nuts("DE9", f"DE5{suffix}", level="level3")
