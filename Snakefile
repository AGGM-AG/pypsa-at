...
ECONTROL_BESTANDSSTATISTIK = dataset_version("econtrol-bestandsstatistik")
ECONTROL_BETRIEBSSTATISTIK = dataset_version("econtrol-betriebsstatistik")
GEONAMES_POSTAL_CODES_AT = dataset_version("geonames-postal-codes-at")
